...
/**
 * Created by Utsav Bansal on 03-08-2017.
 */

public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.MyContentHolder>{
    ...
    @Override
    public MyRecyclerAdapter.MyContentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MyRecyclerAdapter.MyContentHolder holder, final int position) {
        ...
        holder.profess_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent validate=new Intent(view.getContext(),eject_profess_admin.class);
