...
public class recycleradapterstudent extends RecyclerView.Adapter<recycleradapterstudent.MyContentHolder> {
    ...
    public void onBindViewHolder(MyContentHolder holder, final int position) {
        ...
        holder.profess_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent validate=new Intent(view.getContext(),add_comment.class);
                validate.putExtra("t_id",indentity);
